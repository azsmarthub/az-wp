...
calculate_tune() {
    ...
    case "$RAM_TIER" in
        512m)
            TUNE_INNODB_POOL_INSTANCES=1
            TUNE_INNODB_LOG_BUFFER="8M"
            TUNE_INNODB_IO_CAPACITY=500
            TUNE_INNODB_IO_CAPACITY_MAX=1000
            TUNE_INNODB_IO_THREADS=2
            TUNE_MARIADB_THREAD_CACHE=20
            TUNE_MARIADB_TMP_TABLE="16M"
            TUNE_MARIADB_TABLE_CACHE=400
            TUNE_MARIADB_TABLE_DEF_CACHE=200
            ;;
        1g)
            TUNE_INNODB_POOL_INSTANCES=1
            TUNE_INNODB_LOG_BUFFER="16M"
            TUNE_INNODB_IO_CAPACITY=800
            TUNE_INNODB_IO_CAPACITY_MAX=1500
            TUNE_INNODB_IO_THREADS=4
            TUNE_MARIADB_THREAD_CACHE=30
            TUNE_MARIADB_TMP_TABLE="32M"
            TUNE_MARIADB_TABLE_CACHE=800
            TUNE_MARIADB_TABLE_DEF_CACHE=400
            ;;
        2g)
            TUNE_INNODB_POOL_INSTANCES=2
            TUNE_INNODB_LOG_BUFFER="32M"
            TUNE_INNODB_IO_CAPACITY=1000
            TUNE_INNODB_IO_CAPACITY_MAX=2000
            TUNE_INNODB_IO_THREADS=4
            TUNE_MARIADB_THREAD_CACHE=50
            TUNE_MARIADB_TMP_TABLE="64M"
            TUNE_MARIADB_TABLE_CACHE=2000
            TUNE_MARIADB_TABLE_DEF_CACHE=1000
            ;;
        4g)
            TUNE_INNODB_POOL_INSTANCES=4
            TUNE_INNODB_LOG_BUFFER="64M"
            TUNE_INNODB_IO_CAPACITY=1500
            TUNE_INNODB_IO_CAPACITY_MAX=3000
            TUNE_INNODB_IO_THREADS=6
            TUNE_MARIADB_THREAD_CACHE=80
            TUNE_MARIADB_TMP_TABLE="128M"
        ...
        8g|*)
            ...
            TUNE_INNODB_IO_CAPACITY_MAX=4000
            TUNE_INNODB_IO_THREADS=8
            TUNE_MARIADB_THREAD_CACHE=100
    ...
    export TUNE_INNODB_BUFFER_POOL TUNE_INNODB_LOG_FILE_SIZE TUNE_INNODB_POOL_INSTANCES
    export TUNE_INNODB_LOG_BUFFER TUNE_INNODB_IO_CAPACITY TUNE_INNODB_IO_CAPACITY_MAX
    export TUNE_INNODB_IO_THREADS
    export TUNE_REDIS_MAXMEM
    export TUNE_NGINX_WORKERS TUNE_NGINX_RLIMIT_NOFILE TUNE_NGINX_WORKER_CONNECTIONS
    export TUNE_MARIADB_MAX_CONNECTIONS TUNE_MARIADB_THREAD_CACHE
    export TUNE_MARIADB_TMP_TABLE TUNE_MARIADB_TABLE_CACHE TUNE_MARIADB_TABLE_DEF_CACHE
